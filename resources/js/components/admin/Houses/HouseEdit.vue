...
<script>
    export default {
        ...
        methods:{
            fetch(){
                this.$http.get('/api/admin/editHouse',{
                    params: {
                        id: this.$route.params.id
                    }
                })
                    .then(response=>{
                        this.id = response.data.house.id;
                        this.name = response.data.house.name;
                        this.floors = response.data.house.floors;
                        this.description = response.data.house.description;
                        this.img = response.data.house.img;
                        this.viewBox = response.data.house.viewBox;
                        this.coordinates = response.data.house.coordinates;
                        this.status_id = response.data.house.status_id;
                        this.object_id = response.data.house.object_id;
                        this.empty_flats = response.data.house.empty_flats;
                        this.info = response.data.house.info;
                        this.location = response.data.house.location;
                        this.video = response.data.house.video;
            ...
            upd(){
                this.$http.post('/api/admin/updateHouse',{
                    id: this.id,
                    name: this.name,
                    floors: this.floors,
