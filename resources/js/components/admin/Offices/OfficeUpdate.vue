...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            fetch(){
                axios.get('/api/admin/editOffice',{
                    params: {
                        officeId: this.$route.params.id
                    }
                })
                    .then(response=>{
                        this.officeId = response.data.office.id;
                        this.officeName = response.data.office.name;
                        this.officeArea = response.data.office.area;
                        this.officeCoast = response.data.office.coast;
                        this.officeCoordinates = response.data.office.coordinates;
                        this.officeDx = response.data.office.dx;
                        this.officeDy = response.data.office.dy;
                        this.officeStatus = response.data.office.status_id;
                        ...
                        this.officeFloor = response.data.office.floor_id;
                    })
                    .catch(error=>{
                        this.hasError = true;
            ...
            upd(){
                axios.post('/api/admin/updateOffice',{
